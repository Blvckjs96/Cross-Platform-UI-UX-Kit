---
name: cross-platform-ux-kit
description: "UI/UX design intelligence. 70+ shadcn components, 45 animations, 60 effects, 50 styles, 21 palettes, 50 font pairings, 20 charts, 12 stacks (React, Next.js, Vue, Nuxt, Svelte, SwiftUI, React Native, Flutter, Tailwind, shadcn/ui, Electron), cross-platform patterns for 5 platforms (Web, Electron, SwiftUI, React Native, Flutter), design tokens (spacing, typography, color, motion). Actions: plan, build, create, design, implement, review, fix, improve, optimize, enhance, refactor, check UI/UX code. Projects: website, landing page, dashboard, admin panel, e-commerce, SaaS, portfolio, blog, mobile app, desktop app, .html, .tsx, .vue, .svelte, .swift. Elements: button, modal, navbar, sidebar, card, table, form, chart, accordion, dialog, sheet, drawer, tooltip, popover. Styles: glassmorphism, claymorphism, minimalism, brutalism, neumorphism, bento grid, dark mode, responsive, skeuomorphism, flat design. Topics: color palette, accessibility, animation, layout, typography, font pairing, spacing, hover, shadow, gradient, cross-platform. Integrations: shadcn/ui MCP for component search and examples."
---
...
```bash
python3 .claude/skills/cross-platform-ux-kit/scripts/search.py "<keyword>" --domain <domain> [-n <max_results>]
```
...
```bash
python3 .claude/skills/cross-platform-ux-kit/scripts/search.py "<keyword>" --stack html-tailwind
```
...
python3 .claude/skills/cross-platform-ux-kit/scripts/search.py "command palette" --pattern

# Search platform-specific guidelines
python3 .claude/skills/cross-platform-ux-kit/scripts/search.py "navigation" --platform swiftui
python3 .claude/skills/cross-platform-ux-kit/scripts/search.py "window" --platform electron
```
...
```bash
python3 .claude/skills/cross-platform-ux-kit/scripts/search.py "fast" --token motion
python3 .claude/skills/cross-platform-ux-kit/scripts/search.py "lg" --token spacing
python3 .claude/skills/cross-platform-ux-kit/scripts/search.py "primary" --token color
```
...
python3 .claude/skills/cross-platform-ux-kit/scripts/search.py "beauty spa wellness service" --domain product

# 2. Search style (based on industry: beauty, elegant)
python3 .claude/skills/cross-platform-ux-kit/scripts/search.py "elegant minimal soft" --domain style

# 3. Search typography
python3 .claude/skills/cross-platform-ux-kit/scripts/search.py "elegant luxury" --domain typography

# 4. Search color palette
python3 .claude/skills/cross-platform-ux-kit/scripts/search.py "beauty spa wellness" --domain color

# 5. Search landing page structure
python3 .claude/skills/cross-platform-ux-kit/scripts/search.py "hero-centric social-proof" --domain landing

# 6. Search UX guidelines
python3 .claude/skills/cross-platform-ux-kit/scripts/search.py "animation" --domain ux
python3 .claude/skills/cross-platform-ux-kit/scripts/search.py "accessibility" --domain ux

# 7. Search stack guidelines (default: html-tailwind)
python3 .claude/skills/cross-platform-ux-kit/scripts/search.py "layout responsive" --stack html-tailwind
```
...
python3 .claude/skills/cross-platform-ux-kit/scripts/search.py "command dialog" --domain component

# 2. Search cross-platform pattern (get implementations for all platforms)
python3 .claude/skills/cross-platform-ux-kit/scripts/search.py "command palette" --pattern

# 3. Search animation patterns
python3 .claude/skills/cross-platform-ux-kit/scripts/search.py "fade zoom" --domain animation

# 4. Search Electron-specific guidelines
python3 .claude/skills/cross-platform-ux-kit/scripts/search.py "window keyboard shortcut" --stack electron

# 5. Search motion tokens for timing
python3 .claude/skills/cross-platform-ux-kit/scripts/search.py "normal ease" --token motion
```
