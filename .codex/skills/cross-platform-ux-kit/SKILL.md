...
```bash
python3 .codex/skills/cross-platform-ux-kit/scripts/search.py "<keyword>" --domain <domain> [-n <max_results>]
```
...
```bash
python3 .codex/skills/cross-platform-ux-kit/scripts/search.py "<keyword>" --stack html-tailwind
```
...
python3 .codex/skills/cross-platform-ux-kit/scripts/search.py "command palette" --pattern

# Search platform-specific guidelines
python3 .codex/skills/cross-platform-ux-kit/scripts/search.py "navigation" --platform swiftui
python3 .codex/skills/cross-platform-ux-kit/scripts/search.py "window" --platform electron
```
...
```bash
python3 .codex/skills/cross-platform-ux-kit/scripts/search.py "fast" --token motion
python3 .codex/skills/cross-platform-ux-kit/scripts/search.py "lg" --token spacing
python3 .codex/skills/cross-platform-ux-kit/scripts/search.py "primary" --token color
```
...
python3 .codex/skills/cross-platform-ux-kit/scripts/search.py "beauty spa wellness service" --domain product

# 2. Search style (based on industry: beauty, elegant)
python3 .codex/skills/cross-platform-ux-kit/scripts/search.py "elegant minimal soft" --domain style

# 3. Search typography
python3 .codex/skills/cross-platform-ux-kit/scripts/search.py "elegant luxury" --domain typography

# 4. Search color palette
python3 .codex/skills/cross-platform-ux-kit/scripts/search.py "beauty spa wellness" --domain color

# 5. Search landing page structure
python3 .codex/skills/cross-platform-ux-kit/scripts/search.py "hero-centric social-proof" --domain landing

# 6. Search UX guidelines
python3 .codex/skills/cross-platform-ux-kit/scripts/search.py "animation" --domain ux
python3 .codex/skills/cross-platform-ux-kit/scripts/search.py "accessibility" --domain ux

# 7. Search stack guidelines (default: html-tailwind)
python3 .codex/skills/cross-platform-ux-kit/scripts/search.py "layout responsive" --stack html-tailwind
```
...
python3 .codex/skills/cross-platform-ux-kit/scripts/search.py "command dialog" --domain component

# 2. Search cross-platform pattern (get implementations for all platforms)
python3 .codex/skills/cross-platform-ux-kit/scripts/search.py "command palette" --pattern

# 3. Search animation patterns
python3 .codex/skills/cross-platform-ux-kit/scripts/search.py "fade zoom" --domain animation

# 4. Search Electron-specific guidelines
python3 .codex/skills/cross-platform-ux-kit/scripts/search.py "window keyboard shortcut" --stack electron

# 5. Search motion tokens for timing
python3 .codex/skills/cross-platform-ux-kit/scripts/search.py "normal ease" --token motion
```
